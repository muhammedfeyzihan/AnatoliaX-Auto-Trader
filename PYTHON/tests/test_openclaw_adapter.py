...
from PYTHON.openclaw_adapter.skill_loader import SkillLoader, OpenClawSkill
...
- interval: str = 1d
## Handler
PYTHON.paper_trading.signal_engine:SignalEngine.run_scan
"""
        loader = SkillLoader()
        skill = loader.load_from_string(md)
        assert skill is not None
        assert skill.name == "signal_scan"
        assert skill.handler == "PYTHON.paper_trading.signal_engine:SignalEngine.run_scan"

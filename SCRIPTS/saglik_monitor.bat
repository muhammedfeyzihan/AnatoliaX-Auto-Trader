...
set LOG=C:\Users\feyzi\.openclaw\scripts\saglik.log
...
set SIGNALR_PID_FILE=C:\Users\feyzi\.openclaw\scripts\signalr.pid
set OPENCLAW="C:\Users\feyzi\AppData\Roaming\npm\openclaw.cmd"
...
if %errorlevel% neq 0 (
    ...
    start /min "" node "C:\Users\feyzi\.openclaw\scripts\webhook_server.js"
...
if %errorlevel% neq 0 (
    ...
    start /min "" powershell -WindowStyle Hidden -ExecutionPolicy Bypass -File "C:\Users\feyzi\.openclaw\scripts\telegram_listener.ps1"
...
if %errorlevel% neq 0 (
    ...
    start /min "" cmd /c "cd /d C:\Users\feyzi\.openclaw & node scripts\biquote_signalr.js > nul 2>&1 & echo !errorlevel! > %SIGNALR_PID_FILE%"
    timeout //t 3 //nobreak > nul
